...
class FormatData(object):
    def __init__(self, data):
        ...
        f = open('../../data/entity2dic_40002.json')
        self.en_dic = json.loads(f.read())

        f2 = open('../../data/word-cooccurance.txt')
        self.cooccurance = [json.loads(x) for x in f2.readlines()]

        f3 = open('../../data/triple2id_quchong_xushang_40002.txt')
    ...
    def get(self,data1):
        ...
        for i_data in self.data:
            ...
            total_list.append([positive_list, negative_list])
    ...
    def get_batch(self,batch_size,data):#data = total_list
        ...
        for i in all_batch[self.start:batch_index]:
            po = []
            bac, sent, sent_entity, sent_len, ground_truth,positive_list,negative_list = i
        ...
        return bac_li,sent_li,sent_entity_li,sent_len_li,ph_li,pt_li,pr_li,nh_li,nt_li,nr_li,ground_truth_li
